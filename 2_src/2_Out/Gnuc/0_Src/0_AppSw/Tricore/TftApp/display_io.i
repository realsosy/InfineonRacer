# 1 "0_Src/0_AppSw/Tricore/TftApp/display_io.c"
...
# 1 "0_Src/0_AppSw/Tricore/TftApp/display_io.h" 1
...
# 5 "0_Src/0_AppSw/Tricore/TftApp/display_io.h" 2

void display_io_init(void);
void display_io_run(void);
# 6 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 7 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 8 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 45 "c:\\hightec\\toolchains\\tricore\\v4.6.6.0-infineon-1.1\\bin\\../lib/gcc/tricore/4.6.4/../../../../tricore/include/stdio.h" 3
...
# 9 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 10 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
...
# 12 "0_Src/0_AppSw/Tricore/TftApp/display_io.c" 2
# 46 "0_Src/0_AppSw/Tricore/TftApp/display_io.c"
void display_io_init(void)
{
...
void display_io_run(void)
{
 ...
 conio_ascii_printfxy (DISPLAY_IO1, 0, 4, (uint8 *)" Motor0En : %4d     Motor1En : %4d", IR_MotorEn.Motor0Enable, IR_MotorEn.Motor1Enable);
 conio_ascii_printfxy (DISPLAY_IO1, 0, 5, (uint8 *)" Motor0Vol: %4.2f     Motor1En: %4.2f", IR_Motor.Motor0Vol, IR_Motor.Motor1Vol);
 conio_ascii_printfxy (DISPLAY_IO1, 0, 6, (uint8 *)" SrvAngle : %4.2f", IR_Srv.Angle);

 conio_ascii_printfxy (DISPLAY_IO1, 0, 8, (uint8 *)" EncSpeed : %4.0f     EncPos   : %4d", IR_Encoder.speed, IR_Encoder.rawPosition);

 conio_ascii_printfxy (DISPLAY_IO1, 0, 10, (uint8 *)" AdcChn15 : %4.2f     AdcChn16 : %4.2f", IR_AdcResult[0], IR_AdcResult[1]);
 conio_ascii_printfxy (DISPLAY_IO1, 0, 11, (uint8 *)" AdcChn20 : %4.2f     AdcChn21 : %4.2f", IR_AdcResult[2], IR_AdcResult[3]);

 conio_ascii_printfxy (DISPLAY_IO1, 0, 13, (uint8 *)" PORT00_0 : %4d     PORT00_1 : %4d", IR_Port.port00_0, IR_Port.port00_1);

 conio_ascii_printfxy (DISPLAY_IO1, 0, 15, (uint8 *)" BP_Freq  : %4.0f     BP_VOL  : %4.2f", IR_Beeper.Frequency, IR_Beeper.Volume);
}
