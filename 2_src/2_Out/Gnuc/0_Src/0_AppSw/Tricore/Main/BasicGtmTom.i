# 1 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c"
# 28 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c"
...
# 29 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c" 2
# 1 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.h" 1
# 36 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.h"
...
# 37 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.h" 2
...
# 38 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.h" 2
...
# 30 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c" 2
# 43 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c"
typedef struct
{
 float32 gtmFreq;
 float32 gtmGclkFreq;
...
Basic_Gtm g_Gtm;
Basic_GtmTomPwmHl g_GtmTomPwmHl;
...
# 123 "0_Src/0_AppSw/Tricore/Main/BasicGtmTom.c"
...
{
    {
        ...
        IfxGtm_Tom_Timer_initConfig(&timerConfig, &(*(Ifx_GTM *)0xF0100000u));
        ...
        ccx[0] = &IfxGtm_TOM0_9_TOUT1_P02_1_OUT;
        coutx[0] = &IfxGtm_TOM0_10_TOUT12_P00_3_OUT;
        ccx[1] = &IfxGtm_TOM0_11_TOUT3_P02_3_OUT;
        coutx[1] = &IfxGtm_TOM0_12_TOUT14_P00_5_OUT;
        ...
        pwmHlConfig.base.emergencyEnabled = 0;
...
{
    {
        ...
        timerConfig.base.minResolution = (1.0 / timerConfig.base.frequency) / 1000;
        timerConfig.base.trigger.enabled = 0;
        timerConfig.tom = IfxGtm_TOM0_7_TOUT32_P33_10_OUT.tom;
        timerConfig.timerChannel = IfxGtm_TOM0_7_TOUT32_P33_10_OUT.channel;
        timerConfig.clock = IfxGtm_Tom_Ch_ClkSrc_cmuFxclk2;

        timerConfig.triggerOut = &IfxGtm_TOM0_7_TOUT32_P33_10_OUT;
        timerConfig.base.trigger.outputEnabled = 1;
...
sint32 GtmTomBeeper_init (void)
{
 ...
 IfxGtm_Tom_Timer_initConfig(&timerConfig, &(*(Ifx_GTM *)0xF0100000u));
 timerConfig.tom = IfxGtm_TOM0_4_TOUT22_P33_0_OUT.tom;
 timerConfig.timerChannel = IfxGtm_TOM0_4_TOUT22_P33_0_OUT.channel;
 timerConfig.triggerOut = &IfxGtm_TOM0_4_TOUT22_P33_0_OUT;
 ...
 IfxPort_setPinModeInput(IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.port, IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.pinIndex, IfxPort_Mode_inputPullDown);
...
void BasicGtmTom_init(void)
{
 ...
 Ifx_GTM *gtm = &(*(Ifx_GTM *)0xF0100000u);
  ...
  g_Gtm.gtmCmuClk0Freq = IfxGtm_Cmu_getClkFrequency(gtm, IfxGtm_Cmu_Clk_0, 1);
    }
...
void GtmTomBeeper_run(void){
 ...
 if(g_GtmTomBeeper.cmdBeeper == 1){
  ...
  IfxGtm_Tom_Timer_applyUpdate(timer);
  IfxPort_setPinModeOutput(IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.port, IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.pinIndex, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_alt1);
 }
 else
 {
  IfxPort_setPinModeInput(IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.port, IfxGtm_TOM0_4_TOUT22_P33_0_OUT.pin.pinIndex, IfxPort_Mode_inputPullDown);
