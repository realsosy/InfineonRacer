# 1 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
# 11 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
...
# 12 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 13 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 14 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 15 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 16 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 17 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
...
# 18 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c" 2
# 31 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
#pragma section ".data_cpu0" awc0
# 63 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
...
#pragma section
# 111 "0_Src/2_CDrv/Tricore/Tft/libtft_graphics.c"
void display_graphics_clrscr (TDISPLAYMODE displaymode)
{
    if (FIFO_DISPLAY_FREE () > 2)
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE3 | 0x00020000);
...
void display_graphics_textattr (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFEB | 0x00020000);
...
void display_graphics_textcolor (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFEC | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_graphics_textbackground (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFED | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_graphics_gotoxy (TDISPLAYMODE displaymode, sint32 x, sint32 y)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFF4 | 0x00030000);
        PUT_FIFO_DISPLAY (displaymode);
...
void display_graphics_cputs (TDISPLAYMODE displaymode, uint8 * s)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFF6);
...
void display_graphics_printfxy (TDISPLAYMODE displaymode, sint32 x, sint32 y, const uint8 * format, ...)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFE5);
        PUT_FIFO_DISPLAY (displaymode);
        PUT_FIFO_DISPLAY ((x << 16) + y);
...
void display_graphics_printf (TDISPLAYMODE displaymode, const uint8 * format, ...)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFF5);
        PUT_FIFO_DISPLAY (displaymode);
        pbuf = (uint32 *) & buffer[0];
        for (i = 0; i < (len - 2); i += 1)
            PUT_FIFO_DISPLAY (pbuf[i]);
...
void display_graphics_line (TDISPLAYMODE displaymode, sint32 x1, sint32 y1, sint32 x2, sint32 y2, uint8 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE1 | 0x00040000);
...
void conio_graphics_cputs (TDISPLAYMODE displaymode, uint8 * s)
{
    ...
    while (*s != 0)
    {
        if (s[i] > 0x0D)
        {
            ...
            if (conio_driver.display[displaymode].x == 320)
            {
...
void conio_graphics_char (TDISPLAYMODE displaymode, sint32 x, sint32 y, uint8 ch, uint8 color)
{
    ...
    uint8 mask;
    {
        ...
        for (i = 0; i < 12; i += 1)
        {
            ...
            for (j = 0; j < 8; j += 1)
            {
                if ((__font_bitmap__8_12[(ind * 12) + i] & mask) != 0)
                {
                    conio_graphics_set_opt (displaymode, x + j, 12 - i + y, color & 0xF);
                }
                else
                {
                    conio_graphics_set_opt (displaymode, x + j, 12 - i + y, (color & 0xF0) >> 4);
                }
                mask = mask >> 1;
            }
        }
...
static uint32 tft_graphics_lines_written(void)
{
 ...
 else
 {
     ...
     tft_flush_row_buff( &tft_graphics_lines_written, 12*(320/8)*8);
 }
 return 0;
}
