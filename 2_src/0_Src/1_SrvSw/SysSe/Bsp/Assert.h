 ...
 * \return void
 */
IFX_EXTERN void Ifx_Assert_doLevel (uint8 level, pchar __assertion, pchar __file, unsigned int __line,
                                    pchar __function);
 ...
 * \return expr
 */
IFX_EXTERN boolean Ifx_Assert_doValidate (boolean expr, uint8 level, pchar __assertion, pchar __file,
