# 1 "0_Src/4_McHal/Tricore/_PinMap/IfxQspi_PinMap.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/_PinMap/IfxQspi_PinMap.c"
# 26 "0_Src/4_McHal/Tricore/_PinMap/IfxQspi_PinMap.c"
...
# 27 "0_Src/4_McHal/Tricore/_PinMap/IfxQspi_PinMap.c" 2
...
IfxQspi_Mrst_In IfxQspi0_MRSTD_P14_6_IN = {&(*(Ifx_QSPI *)0xF0001C00u), {&(*(Ifx_P *)0xF003B400u), 6}, Ifx_RxSel_d};
...
IfxQspi_Mtsr_In IfxQspi1_MTSRC_P11_8_IN = {&(*(Ifx_QSPI *)0xF0001D00u), {&(*(Ifx_P *)0xF003B100u), 8}, Ifx_RxSel_c};
...
IfxQspi_Mtsr_Out IfxQspi1_MTSR_P11_8_OUT = {&(*(Ifx_QSPI *)0xF0001D00u), {&(*(Ifx_P *)0xF003B100u), 8}, IfxPort_OutputIdx_alt4};
IfxQspi_Mtsr_Out IfxQspi1_MTSR_P11_9_OUT = {&(*(Ifx_QSPI *)0xF0001D00u), {&(*(Ifx_P *)0xF003B100u), 9}, IfxPort_OutputIdx_alt3};
IfxQspi_Mtsr_Out IfxQspi2_MTSR_P13_3_OUT = {&(*(Ifx_QSPI *)0xF0001E00u), {&(*(Ifx_P *)0xF003B300u), 3}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Sclk_Out IfxQspi2_SCLK_P13_0_OUT = {&(*(Ifx_QSPI *)0xF0001E00u), {&(*(Ifx_P *)0xF003B300u), 0}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi1_SLSO10_P11_8_OUT = {&(*(Ifx_QSPI *)0xF0001D00u), 10, {&(*(Ifx_P *)0xF003B100u), 8}, IfxPort_OutputIdx_alt3};
...
const IfxQspi_Hsicin_In *IfxQspi_Hsicin_In_pinTable[4][2] = {
    {
        ((void *)0),
        ((void *)0)
    },
...
const IfxQspi_Mrst_In *IfxQspi_Mrst_In_pinTable[4][5] = {
    {
...
const IfxQspi_Mrst_Out *IfxQspi_Mrst_Out_pinTable[4][3] = {
    {
...
const IfxQspi_Mtsr_Out *IfxQspi_Mtsr_Out_pinTable[4][4] = {
    {
...
const IfxQspi_Sclk_Out *IfxQspi_Sclk_Out_pinTable[4][4] = {
    {
