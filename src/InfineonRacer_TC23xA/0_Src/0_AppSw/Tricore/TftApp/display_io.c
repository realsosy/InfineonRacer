...
void display_io_run(void)
{
	...
	conio_ascii_printfxy (DISPLAY_IO1, 0,  10, (uint8 *)" AdcChn15 : %4.2f     AdcChn16 : %4.2f", IR_getChn15(), IR_getChn16());
	conio_ascii_printfxy (DISPLAY_IO1, 0,  11, (uint8 *)" AdcChn20 : %4.2f     AdcChn21 : %4.2f", IR_getChn20(), IR_getChn21());
