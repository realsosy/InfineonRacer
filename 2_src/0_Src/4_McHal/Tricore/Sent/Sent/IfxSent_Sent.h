...
typedef struct
{
    const IfxSent_Sent_In *in;            /**< \brief Specifies input pin configuration */
    IfxPort_InputMode      inMode;        /**< \brief Specifies input pin mode */
    const IfxSent_Spc_Out *out;           /**< \brief Specifies output pin configuration */
...
typedef struct
{
    ...
    const IfxSent_Sent_Pins          *pins;                    /**< \brief Specifies the pins configuration for SENT channel */
