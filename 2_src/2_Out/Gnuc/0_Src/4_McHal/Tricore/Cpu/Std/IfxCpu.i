# 1 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
# 30 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
...
# 31 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c" 2
...
{
# 159 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    uint32 x = *seed;
    ...
    uint32 m = 0xfffffffb;
    uint32 result;
# 180 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
...
# 220 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    * seed = result;
...
{
# 366 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    uint8 reqslp;
    boolean retValue;
    IfxCpu_ResourceCpu index = IfxCpu_getIndex(cpu);
