# 1 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c"
...
# 3 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c" 2
...
# 4 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c" 2
...
# 5 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c" 2
...
# 6 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c" 2
...
# 7 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c" 2
# 19 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c"
...
# 61 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c"
...
#pragma section
# 80 "0_Src/2_CDrv/Tricore/Tft/conio_tft.c"
...
void conio_periodic (sint16 x, sint16 y, TDISPLAYENTRY * pmenulist, TDISPLAYENTRY * pstdlist)
{
    ...
    if ((conio_driver.dasstatus == 0) && (conio_driver.pdasmirror != 0))
    {
        i = 0;
    ...
    control.timebeg[0] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));
    ...
    if (conio_driver.dialogmode == DIALOGOFF)
    {
        ...
        conio_ascii_textbackground (DISPLAY_BAR, 5);
        ...
        if (y == ((240/12)-1))
        {
            ...
            conio_ascii_textchangebackground (DISPLAY_BAR, 2);
        }
    }
    ...
    control.timeend[0] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));

    control.timebeg[6] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));

    {
        ...
        {
            uint32 val;
            if (GET_FIFO_DISPLAY_NODROP (&val) == 0)
            {
    ...
    control.timeend[6] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));
    control.timebeg[1] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));
    if (conio_driver.display[conio_driver.displaymode].mode == TEXTMODE)
    {
    ...
    control.timeend[1] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));
