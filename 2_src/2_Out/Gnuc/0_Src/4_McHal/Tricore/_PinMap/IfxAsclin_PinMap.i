...
IfxAsclin_Cts_In IfxAsclin0_CTSA_P00_12_IN = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u),12}, Ifx_RxSel_a};
IfxAsclin_Cts_In IfxAsclin1_CTSA_P20_7_IN = {&(*(Ifx_ASCLIN *)0xF0000700u), {&(*(Ifx_P *)0xF003C000u), 7}, Ifx_RxSel_a};
IfxAsclin_Cts_In IfxAsclin1_CTSB_P34_3_IN = {&(*(Ifx_ASCLIN *)0xF0000700u), {&(*(Ifx_P *)0xF003D400u), 3}, Ifx_RxSel_b};
IfxAsclin_Rts_Out IfxAsclin0_RTS_P00_9_OUT = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 9}, IfxPort_OutputIdx_alt3};
...
IfxAsclin_Rx_In IfxAsclin0_RXC_P00_1_IN = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 1}, Ifx_RxSel_c};
...
IfxAsclin_Rx_In IfxAsclin1_RXF_P33_6_IN = {&(*(Ifx_ASCLIN *)0xF0000700u), {&(*(Ifx_P *)0xF003D300u), 6}, Ifx_RxSel_f};
IfxAsclin_Rx_In IfxAsclin1_RXG_P02_3_IN = {&(*(Ifx_ASCLIN *)0xF0000700u), {&(*(Ifx_P *)0xF003A200u), 3}, Ifx_RxSel_g};
IfxAsclin_Sclk_Out IfxAsclin0_SCLK_P00_0_OUT = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 0}, IfxPort_OutputIdx_alt2};
IfxAsclin_Sclk_Out IfxAsclin0_SCLK_P00_2_OUT = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 2}, IfxPort_OutputIdx_alt2};
...
IfxAsclin_Tx_Out IfxAsclin0_TX_P00_0_OUT = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 0}, IfxPort_OutputIdx_alt3};
IfxAsclin_Tx_Out IfxAsclin0_TX_P00_1_OUT = {&(*(Ifx_ASCLIN *)0xF0000600u), {&(*(Ifx_P *)0xF003A000u), 1}, IfxPort_OutputIdx_alt2};
...
IfxAsclin_Tx_Out IfxAsclin1_TX_P33_6_OUT = {&(*(Ifx_ASCLIN *)0xF0000700u), {&(*(Ifx_P *)0xF003D300u), 6}, IfxPort_OutputIdx_alt4};


const IfxAsclin_Cts_In *IfxAsclin_Cts_In_pinTable[2][2] = {
    {
...
const IfxAsclin_Rts_Out *IfxAsclin_Rts_Out_pinTable[2][2] = {
    {
...
const IfxAsclin_Rx_In *IfxAsclin_Rx_In_pinTable[2][7] = {
    {
...
const IfxAsclin_Sclk_Out *IfxAsclin_Sclk_Out_pinTable[2][4] = {
    {
...
const IfxAsclin_Slso_Out *IfxAsclin_Slso_Out_pinTable[2][3] = {
    {
        ((void *)0),
        ((void *)0),
        ((void *)0)
...
const IfxAsclin_Tx_Out *IfxAsclin_Tx_Out_pinTable[2][9] = {
    {
