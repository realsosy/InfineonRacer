# 1 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
# 10 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
...
# 11 "0_Src/2_CDrv/Tricore/Tft/tfthw.c" 2
...
# 12 "0_Src/2_CDrv/Tricore/Tft/tfthw.c" 2
...
# 13 "0_Src/2_CDrv/Tricore/Tft/tfthw.c" 2
...
# 14 "0_Src/2_CDrv/Tricore/Tft/tfthw.c" 2
# 31 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
typedef struct
{
    struct
    {
...
# 48 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
#pragma section
#pragma section ".bss_cpu0" awc0
# 82 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
uint16 Row_Buff[12*320] __attribute__ ((aligned(4)));
...
#pragma section
# 108 "0_Src/2_CDrv/Tricore/Tft/tfthw.c"
...
static void tft_read_data_ili9341 (uint8 regaddr, uint16 *puiData, uint32 count)
{
    ...
    IfxPort_setPinLow(IfxQspi0_SCLK_P20_11_OUT.pin.port, IfxQspi0_SCLK_P20_11_OUT.pin.pinIndex);

    IfxPort_setPinMode(IfxQspi0_SCLK_P20_11_OUT.pin.port, IfxQspi0_SCLK_P20_11_OUT.pin.pinIndex, IfxPort_Mode_outputPushPullGeneral);

    IfxPort_togglePin(IfxQspi0_SCLK_P20_11_OUT.pin.port, IfxQspi0_SCLK_P20_11_OUT.pin.pinIndex);

    IfxPort_togglePin(IfxQspi0_SCLK_P20_11_OUT.pin.port, IfxQspi0_SCLK_P20_11_OUT.pin.pinIndex);

    IfxPort_setPinMode(IfxQspi0_SCLK_P20_11_OUT.pin.port, IfxQspi0_SCLK_P20_11_OUT.pin.pinIndex, IfxQspi0_SCLK_P20_11_OUT.select);
...
void tft_init (void)
{
    ...
    g_Qspi_Tft.drivers.spiMaster = qspi0_init();
...

    {
        ...
        const IfxQspi_SpiMaster_Output slsOutput = {&IfxQspi0_SLSO8_P20_6_OUT,
    ...
    if (tft_id == 0x9341)
    {
     ...
     uwData[2] = 0x0030;
     uwData[3] = 0x0000;
     tft_write_data_ili9341(0xCF, &uwData[0], 4);
     ...
     uwData[3] = 0x0081;
     uwData[4] = 0x0000;
     tft_write_data_ili9341(0xED, &uwData[0], 5);

     uwData[0] = 0x0085;
     uwData[1] = 0x0000;
     uwData[2] = 0x0078;
     uwData[3] = 0x0000;
     tft_write_data_ili9341(0xE8, &uwData[0], 4);
     ...
     uwData[4] = 0x0002;
     uwData[5] = 0x0000;
     tft_write_data_ili9341(0xCB, &uwData[0], 6);

     uwData[0] = 0x0020;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0xF7, &uwData[0], 2);

     uwData[0] = 0x0000;
     uwData[1] = 0x0000;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0xEA, &uwData[0], 3);

     uwData[0] = 0x0019;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0xC0, &uwData[0], 2);

     uwData[0] = 0x0011;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0xC1, &uwData[0], 2);
     ...
     uwData[0] = 0x0028;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0x36, &uwData[0], 2);

     uwData[0] = 0x0055;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0x3A, &uwData[0], 2);

     uwData[0] = 0x0000;
     uwData[1] = 0x0017;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0xB1, &uwData[0], 3);

     uwData[0] = 0x000A;
     uwData[1] = 0x00A2;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0xB6, &uwData[0], 3);

     uwData[0] = 0x0001;
     uwData[1] = 0x0030;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0xF6, &uwData[0], 3);

     uwData[0] = 0x0000;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0xF2, &uwData[0], 2);

     uwData[0] = 0x0001;
     uwData[1] = 0x0000;
     tft_write_data_ili9341(0x26, &uwData[0], 2);
     ...
     uwData[14] = 0x0000;
     uwData[15] = 0x0000;
     tft_write_data_ili9341(0xE0, &uwData[0], 16);
     ...
     uwData[14] = 0x000F;
     uwData[15] = 0x0000;
     tft_write_data_ili9341(0xE1, &uwData[0], 16);

     uwData[0] = 0x0000;
     uwData[1] = 0x0000;
     uwData[2] = ((320 -1) & 0xFF00)>>8;
     uwData[3] = (320 -1) & 0x00FF;
     uwData[4] = 0x0000;
     tft_write_data_ili9341(0x2A, &uwData[0], 5);

     uwData[0] = 0x0000;
     uwData[1] = 0x0000;
     uwData[2] = ((240 -1) & 0xFF00)>>8;
     uwData[3] = (240 -1) & 0x00FF;
     uwData[4] = 0x0000;
     tft_write_data_ili9341(0x2B, &uwData[0], 5);

     uwData[0] = 0x0000;
     tft_write_data_ili9341(0x11, &uwData[0], 1);

        delay_ms (120);

     uwData[0] = 0x0000;
     tft_write_data_ili9341(0x29, &uwData[0], 1);
    }
    else
    {
        if (tft_id == 0x47)
        {
            ...
            tft_write_data (0x0019, 0x0001);
            tft_write_data (0x001F, 0x0088);
            delay_ms (5);
            tft_write_data (0x001F, 0x0080);
            delay_ms (5);
            tft_write_data (0x001F, 0x0090);
            delay_ms (5);
            tft_write_data (0x001F, 0x00D0);
            delay_ms (5);

            tft_write_data (0x0017, 0x0005);


            tft_write_data (0x0016, 0x0028);
            tft_write_data (0x0036, 0x0000);

            tft_write_data (0x0028, 0x0038);
            delay_ms (40);
            tft_write_data (0x0028, 0x003C);

            tft_write_data (0x0002, 0x0000);
            tft_write_data (0x0003, 0x0000);
            tft_write_data (0x0004, 0x0001);
            tft_write_data (0x0005, 0x003F);
            tft_write_data (0x0006, 0x0000);
            tft_write_data (0x0007, 0x0000);
            tft_write_data (0x0008, 0x0000);
            tft_write_data (0x0009, 0x00EF);
        }
        else
        {

            tft_write_data (0x00, 0x0001);
            tft_write_data (0x01, 0x0100);
            tft_write_data (0x02, 0x0700);
            tft_write_data (0x0003, 0x1038);
            tft_write_data (0x04, 0x0000);
            tft_write_data (0x08, 0x0202);
            tft_write_data (0x09, 0x0000);
            tft_write_data (0x0A, 0x0000);

            tft_write_data (0x10, 0x0080);
            tft_write_data (0x11, 0x0007);
            tft_write_data (0x12, 0x0000);
            tft_write_data (0x13, 0x0000);
            tft_write_data (0x07, 0x0001);

            delay_ms (2000);


            tft_write_data (0x10, 0x1290);
            tft_write_data (0x11, 0x0227);
            delay_ms (1000);
            tft_write_data (0x12, 0x001C);
            delay_ms (1000);
            tft_write_data (0x13, 0x1600);
            tft_write_data (0x29, 0x0012);
            tft_write_data (0x2B, 0x000D);
            delay_ms (500);
            ...
            tft_write_data (0x0050, 0x0000);
            tft_write_data (0x0051, 0x00EF);
            tft_write_data (0x0052, 0x0000);
            tft_write_data (0x0053, 0x013F);
            tft_write_data (0x0060, 0xA700);
            tft_write_data (0x0061, 0x0001);
            tft_write_data (0x006A, 0x0000);
...
void tft_display_setxy (uint32 x, uint32 y)
{
    if (tft_id == 0x9341)
    {
     ...
     uwData[1] = (uint16) x;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0x2A, &uwData[0], 3);

     uwData[0] = (uint16) (y >> 8);
     uwData[1] = (uint16) y;
     uwData[2] = 0x0000;
     tft_write_data_ili9341(0x2B, &uwData[0], 3);
    }
    else
    {
        if (tft_id == 0x47)
        {
            ...
            tft_write_data (0x0003, (uint16) x);
            tft_write_data (0x0006, (uint16) (y >> 8));
            tft_write_data (0x0007, (uint16) y);
        }
        else
        {
