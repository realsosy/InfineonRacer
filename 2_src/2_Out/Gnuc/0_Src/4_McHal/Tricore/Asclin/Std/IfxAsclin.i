# 1 "0_Src/4_McHal/Tricore/Asclin/Std/IfxAsclin.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Asclin/Std/IfxAsclin.c"
# 29 "0_Src/4_McHal/Tricore/Asclin/Std/IfxAsclin.c"
...
# 30 "0_Src/4_McHal/Tricore/Asclin/Std/IfxAsclin.c" 2
...
{
    uint32 base = (uint32)&(*(Ifx_ASCLIN *)0xF0000600u);
    uint32 singleDistance = ((uint32)&(*(Ifx_ASCLIN *)0xF0000700u)) - base;
...
{
    return &(*(Ifx_SRC *)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].ERR;
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerRx(Ifx_ASCLIN *asclin)
{
    return &(*(Ifx_SRC *)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].RX;
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerTx(Ifx_ASCLIN *asclin)
{
    return &(*(Ifx_SRC *)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].TX;
}
