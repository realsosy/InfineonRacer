 ...
 */
IFX_EXTERN IfxStdIf_Pos_RawAngle Ifx_AngleTrkF32_getRawPosition(Ifx_AngleTrkF32 *driver);
 ...
 * \return speed
 */
IFX_EXTERN float32 Ifx_AngleTrkF32_getSpeed(Ifx_AngleTrkF32 *driver);
 ...
 * \return None
 */
IFX_EXTERN void Ifx_AngleTrkF32_setOffset(Ifx_AngleTrkF32 *driver, IfxStdIf_Pos_RawAngle offset);
 ...
 * \return None
 */
IFX_EXTERN void Ifx_AngleTrkF32_update(Ifx_AngleTrkF32 *driver);
