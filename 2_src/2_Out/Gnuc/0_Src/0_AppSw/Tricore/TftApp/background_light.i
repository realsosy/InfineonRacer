# 1 "0_Src/0_AppSw/Tricore/TftApp/background_light.c"
...
# 9 "0_Src/0_AppSw/Tricore/TftApp/background_light.c" 2
...
# 10 "0_Src/0_AppSw/Tricore/TftApp/background_light.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/TftApp/background_light.c" 2
...
# 12 "0_Src/0_AppSw/Tricore/TftApp/background_light.c" 2
...
# 13 "0_Src/0_AppSw/Tricore/TftApp/background_light.c" 2
# 31 "0_Src/0_AppSw/Tricore/TftApp/background_light.c"
#pragma section ".bss_cpu0" awc0
# 66 "0_Src/0_AppSw/Tricore/TftApp/background_light.c"
...
#pragma section
# 85 "0_Src/0_AppSw/Tricore/TftApp/background_light.c"
extern TTOUCH_EVENT touch_event;
# 94 "0_Src/0_AppSw/Tricore/TftApp/background_light.c"
void background_light_init (void)
{
 ...
 IfxGtm_Tom_Timer_Config driverConfig;
    ...
    driverConfig.tom = IfxGtm_TOM1_1_TOUT69_P20_13_OUT.tom;
    driverConfig.timerChannel = IfxGtm_TOM1_1_TOUT69_P20_13_OUT.channel;
    ...
    driverConfig.base.frequency = (float32) ((100) * 100);
    driverConfig.base.minResolution = 0;
    driverConfig.base.trigger.enabled = 1;
    driverConfig.base.trigger.outputEnabled = 1;
    ...
    driverConfig.base.trigger.triggerPoint = (100) * backgroundlightsize;
    driverConfig.base.trigger.risingEdgeAtPeriod = 1;
    driverConfig.base.isrPriority = 15;
...
void ISR_BACKLIGHT(void)
{
 ...
 {
  IfxGtm_Tom_Timer_setTrigger (&driverBacklight, (100) * backgroundlightsize);
  time_out_bkgrnd = 0;
 }
 else
 {
  if(time_out_bkgrnd >= 150000 - (100) * 50)
   IfxGtm_Tom_Timer_setTrigger (&driverBacklight, (100) * 5);

  else if((time_out_bkgrnd > 150000 - backgroundlightsize*1000) && (time_out_bkgrnd < 150000 - (100) * 50))
  {
   IfxGtm_Tom_Timer_setTrigger (&driverBacklight, (150000 - time_out_bkgrnd)/10);
   time_out_bkgrnd++;
  }
