# 1 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
# 11 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
...
# 12 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 13 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 14 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 15 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 16 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 17 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
...
# 18 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c" 2
# 31 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
#pragma section ".data_cpu0" awc0
# 63 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
TCOLORTABLEASCII colortable_ascii =
{
 (((0 & 0xF8) << 8) | ((0 & 0xFC) << 3) | ((0 & 0xF8) >> 3)), (((255 & 0xF8) << 8) | ((255 & 0xFC) << 3) | ((255 & 0xF8) >> 3)), (((255 & 0xF8) << 8) | ((0 & 0xFC) << 3) | ((0 & 0xF8) >> 3)), (((0 & 0xF8) << 8) | ((255 & 0xFC) << 3) | ((0 & 0xF8) >> 3)), (((139 & 0xF8) << 8) | ((69 & 0xFC) << 3) | ((19 & 0xF8) >> 3)), (((0 & 0xF8) << 8) | ((0 & 0xFC) << 3) | ((255 & 0xF8) >> 3)), (((255 & 0xF8) << 8) | ((0 & 0xFC) << 3) | ((255 & 0xF8) >> 3)), (((0 & 0xF8) << 8) | ((255 & 0xFC) << 3) | ((255 & 0xF8) >> 3)),
    (((200 & 0xF8) << 8) | ((200 & 0xFC) << 3) | ((200 & 0xF8) >> 3)), (((80 & 0xF8) << 8) | ((80 & 0xFC) << 3) | ((80 & 0xF8) >> 3)), (((240 & 0xF8) << 8) | ((128 & 0xFC) << 3) | ((128 & 0xF8) >> 3)), (((128 & 0xF8) << 8) | ((240 & 0xFC) << 3) | ((128 & 0xF8) >> 3)), (((255 & 0xF8) << 8) | ((255 & 0xFC) << 3) | ((0 & 0xF8) >> 3)), (((128 & 0xF8) << 8) | ((128 & 0xFC) << 3) | ((240 & 0xF8) >> 3)),
    (((240 & 0xF8) << 8) | ((128 & 0xFC) << 3) | ((240 & 0xF8) >> 3)),
    (((128 & 0xF8) << 8) | ((240 & 0xFC) << 3) | ((240 & 0xF8) >> 3))
};
...
#pragma section
# 97 "0_Src/2_CDrv/Tricore/Tft/libtft_ascii.c"
void display_ascii_clrscr (TDISPLAYMODE displaymode)
{
    if (FIFO_DISPLAY_FREE () > 2)
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE2 | 0x00020000);
...
void display_ascii_clreol (TDISPLAYMODE displaymode)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE7 | 0x00020000);
        PUT_FIFO_DISPLAY (displaymode);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_textattr (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE8 | 0x00020000);
...
void display_ascii_textcolor (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFE9 | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_textbackground (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFEA | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_textchangebackground (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFEE | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_textchangeforeground (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFEF | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_textchangecolor (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFF0 | 0x00020000);
        PUT_FIFO_DISPLAY ((displaymode << 16) + color);
        __asm__ volatile ("enable" : : : "memory");
    }
}
...
void display_ascii_gotoxy (TDISPLAYMODE displaymode, sint32 x, sint32 y)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY (0x0000FFF3 | 0x00030000);
        PUT_FIFO_DISPLAY (displaymode);
...
void display_ascii_cputs (TDISPLAYMODE displaymode, uint8 * s)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFF1);
...
void display_ascii_printfxy (TDISPLAYMODE displaymode, sint32 x, sint32 y, const uint8 * format, ...)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFE4);
        PUT_FIFO_DISPLAY (displaymode);
        PUT_FIFO_DISPLAY ((x << 16) + y);
...
void display_ascii_printf (TDISPLAYMODE displaymode, const uint8 * format, ...)
{
    ...
    {
        __asm__ volatile ("disable" : : : "memory");
        PUT_FIFO_DISPLAY ((len << 16) + 0x0000FFE6);
        PUT_FIFO_DISPLAY (displaymode);
        pbuf = (uint32 *) & buffer[0];
        for (i = 0; i < (len - 2); i += 1)
        {
...
void conio_ascii_clrscr (TDISPLAYMODE displaymode)
{
    ...
    for (i = 0; i < ((240/12) - 1); i += 1)
        for (j = 0; j < (320/8); j += 1)
        {
            conio_driver.display[displaymode].pdisplay[i * (320/8) + j] = 0x20;
            conio_driver.display[displaymode].pdisplaycolor[i * (320/8) + j] =
...
void conio_ascii_clreol (TDISPLAYMODE displaymode)
{
    ...
    for (i = conio_driver.display[displaymode].x; i < (320/8); i += 1)
    {
        conio_driver.display[displaymode].pdisplay[(320/8) * conio_driver.display[displaymode].y + i] = 0x20;
        conio_driver.display[displaymode].pdisplaycolor[(320/8) * conio_driver.display[displaymode].y + i] =
            conio_driver.display[displaymode].color;
    }
}
...
void conio_ascii_textchangebackground (TDISPLAYMODE displaymode, sint32 color)
{
    ...
    conio_driver.display[displaymode].pdisplaycolor[(320/8) * conio_driver.display[displaymode].y +
...
void conio_ascii_cputs (TDISPLAYMODE displaymode, uint8 * s)
{
    ...
    while (s[i] != 0)
    {
        if (s[i] != 0x0A)
        {
            conio_driver.display[displaymode].pdisplay[(320/8) * ytmp + xtmp] = s[i];
            conio_driver.display[displaymode].pdisplaycolor[(320/8) * ytmp + xtmp] =
                conio_driver.display[displaymode].color;
            xtmp += 1;
        }
        else
        ...
        if (ytmp >= ((240/12) - 1))
        {
            ...
            psrcdisplay = (uint32 *) & conio_driver.display[displaymode].pdisplay[(320/8)];
            pdstdisplay = (uint32 *) & conio_driver.display[displaymode].pdisplay[0];
            psrcdisplaycolor = (uint32 *) & conio_driver.display[displaymode].pdisplaycolor[(320/8)];
            pdstdisplaycolor = (uint32 *) & conio_driver.display[displaymode].pdisplaycolor[0];
            for (len = 0; len < (((320/8) * ((240/12) - 2)) / 4); len += 1)
            {
                *pdstdisplay++ = *psrcdisplay++;
                *pdstdisplaycolor++ = *psrcdisplaycolor++;
            }
            for (len = 0; len < ((320/8) / 4); len += 1)
            {
                *pdstdisplay++ = 0x0;
...
static void tft_prepare_ascii_line (uint8 * pdisplay, uint8 * pdisplaycolor)
{
    ...
    for (k = 12 - 1; k >= 0; k -= 1)
    {
        for (j = 0; j < (320/8); j += 1)
        {
            ...
            for (l = 0; l < 8; l += 1)
            {
                if ((__font_bitmap__8_12[(ind * 12) + k] & mask) != 0)
                {
...
static uint32 tft_ascii_line_written(void)
{
 ...
 tft_prepare_ascii_line (&cpy_pdisplay[YROW_cnt*(320/8)], &cpy_pdisplaycolor[YROW_cnt*(320/8)]);

 if (YROW_cnt == 0)
 {


     tft_flush_row_buff( (void *)0, 12*(320/8)*8);
 }
 else
 {
     ...
     YROW_cnt--;
     tft_flush_row_buff( &tft_ascii_line_written, 12*(320/8)*8);
 }
 return 0;
}
