# 1 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
# 30 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
# 1 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.h" 1
# 41 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.h"
...
# 42 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.h" 2
...
# 43 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.h" 2
# 54 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.h"
typedef enum
{
...
# 31 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c" 2
...
# 32 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c" 2
# 70 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
...
# 210 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
void IfxCpu_Trap_vectorTable0(void)
{
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_memoryManagementError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_internalProtectionError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_instructionError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_contextManagementError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_busError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_assertion)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_systemCall_Cpu0)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_nonMaskableInterrupt)); __asm("rfe"); };
}
# 364 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
#pragma section
