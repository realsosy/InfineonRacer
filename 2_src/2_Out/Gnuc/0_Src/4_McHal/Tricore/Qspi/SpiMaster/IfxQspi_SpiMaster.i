# 1 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
# 29 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
# 40 "./0_Src/4_McHal/Tricore/Cpu/Irq/IfxCpu_Irq.h"
# 1 "./0_Src/0_AppSw/Config/Common/Ifx_Cfg.h" 1
# 41 "./0_Src/4_McHal/Tricore/Cpu/Irq/IfxCpu_Irq.h" 2
...
# 42 "./0_Src/4_McHal/Tricore/Cpu/Irq/IfxCpu_Irq.h" 2
...
# 44 "./0_Src/4_McHal/Tricore/Cpu/Irq/IfxCpu_Irq.h" 2
...
# 30 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c" 2
# 42 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
static IfxQspi_SpiMaster_Channel *IfxQspi_SpiMaster_activeChannel(IfxQspi_SpiMaster *handle);
# 57 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
# 106 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
{
    {
        ...
        chConfig.mode.autoCS = (chHandle->activateSlso == (&IfxQspi_SpiMaster_activateSlso)) && (chHandle->deactivateSlso == (&IfxQspi_SpiMaster_deactivateSlso));
...
SpiIf_Status IfxQspi_SpiMaster_initChannel(IfxQspi_SpiMaster_Channel *chHandle, const IfxQspi_SpiMaster_ChannelConfig *chConfig)
{
    ...
    qspiSFR->GLOBALCON.B.LB = chConfig->base.mode.loopback;
    ...
    const IfxQspi_Slso_Out *slso = chConfig->sls.output.pin;
    chHandle->slso = slso->pin;
    chHandle->slsoActiveState = chConfig->base.mode.csActiveLevel;

    if (chHandle->slso.port == ((void *)0))
    {
...
void IfxQspi_SpiMaster_initModule(IfxQspi_SpiMaster *handle, const IfxQspi_SpiMaster_Config *config)
{
    ...
    if (pins != ((void *)0))
    {
        ...
        if (mrstIn != ((void *)0))
        {
            IfxQspi_initMrstInPin(mrstIn, pins->mrstMode);
        }
    }
...
void IfxQspi_SpiMaster_packLongModeBuffer(IfxQspi_SpiMaster_Channel *chHandle, void *data, uint32 *longFifoBuffer, Ifx_SizeT dataLength)
{
    ...
    {
        ((((0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"IFX_ASSERT_FEATURE_NOT_IMPLEMENTED", "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c", 749, __func__));
    }
...
static void IfxQspi_SpiMaster_writeLong(IfxQspi_SpiMaster_Channel *chHandle)
{
    ...
    {
        ((((0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"IFX_ASSERT_FEATURE_NOT_IMPLEMENTED", "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c", 1266, __func__));
    }
}
