# 1 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
...
# 9 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 10 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_reg.h" 1
# 36 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_reg.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h" 1
# 45 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h"
...
# 1013 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h"
typedef volatile struct _Ifx_CBS_TRTGB
{
    Ifx_CBS_TRTGB_L L;
    Ifx_CBS_TRTGB_H H;
} Ifx_CBS_TRTGB;
# 1030 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h"
...
# 37 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_reg.h" 2
# 11 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 55 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
...
# 12 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 13 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 15 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
# 1 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h" 1
# 16 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
...
# 17 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c" 2
# 73 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
#pragma section
#pragma section ".bss_cpu0" awc0
# 84 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
volatile uint32 cpu0_idle_counter;
volatile uint32 cpu0_last_count_value;
volatile uint32 cpu0_ccnt_diff_min;

CpuLoad_t CpuLoad0;
# 97 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
#pragma section
# 108 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
extern volatile boolean tft_ready;
extern App_Cpu g_AppCpu0;
extern App_Cpu g_AppCpu1;
extern App_Cpu g_AppCpu2;
# 122 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
void perf_meas_init(void)
{
# 137 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
    cpu0_idle_counter = 0;
    ...
    if (!((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFD00" : "=d" (__res) :: "memory"); __res; })) & 0x1))
    {
        (*(volatile Ifx_CBS_OEC *)0xF0000478u).U = 0xA1;
        (*(volatile Ifx_CBS_OEC *)0xF0000478u).U = 0x5E;
        (*(volatile Ifx_CBS_OEC *)0xF0000478u).U = 0xA1;
        (*(volatile Ifx_CBS_OEC *)0xF0000478u).U = 0x5E;
    }
 ...
 IfxGtm_Tom_Timer_Config driverConfig;
    ...
    IfxGtm_Tom_Timer_initConfig(&driverConfig, &(*(Ifx_GTM *)0xF0100000u));
    driverConfig.tom = IfxGtm_TOM0_0_TOUT76_P15_5_OUT.tom;
    driverConfig.timerChannel = IfxGtm_TOM0_0_TOUT76_P15_5_OUT.channel;
    driverConfig.irqModeTimer = IfxGtm_IrqMode_pulse;
    driverConfig.triggerOut = &IfxGtm_TOM1_1_TOUT69_P20_13_OUT;
    driverConfig.irqModeTrigger = IfxGtm_IrqMode_pulse;
    driverConfig.clock = IfxGtm_Tom_Ch_ClkSrc_cmuFxclk3;
    driverConfig.base.frequency = 1.0f;
    driverConfig.base.minResolution = 0;
    driverConfig.base.trigger.enabled = 1;
    driverConfig.base.trigger.outputEnabled = 0;
    ...
    driverConfig.base.trigger.risingEdgeAtPeriod = 1;
    driverConfig.base.isrPriority = 255;
    driverConfig.base.isrProvider = 0;
...
void perf_meas_idle(void){
 ...
 cpu0_ccnt_actual = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFC04" : "=d" (__res) :: "memory"); __res; }));
...
void ISR_perf_meas_call(void)
{
    ...
    __asm__ volatile ("bisr " "64-1" ::: "memory");
...
# 252 "0_Src/0_AppSw/Tricore/TftApp/Perf_Meas.c"
    __rslcx();
