# 1 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
...
# 6 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 7 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 8 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 9 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 12 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 13 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c" 2
...
typedef uint8 TDISPLAY_GRAPHICS0[(320*(240 -12))/2];
# 36 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
extern void keyboard (sint16 x, sint16 y);
# 51 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
#pragma section ".bss_cpu0" awc0
# 86 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
...
uint32 das_buffer[(16 * 2 + 2* (320/8) + 256 * 2 + ((320*(240 -12)) / 2)) >> 2];
...
#pragma section
# 122 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
volatile boolean tft_ready;



const TCONIODLGENTRY conio_dialog_list[1] =
{
    { KEYBOARDON, &keyboard },
};

const TCONIODMENTRY conio_displaymode_list[6] =
{
    { DISPLAY_BAR, {(uint8 *) & display_bar, (uint8 *) & displaycolor_bar, TEXTMODE, 1, (320/8), 1, 0, 0} },
    { DISPLAY_MENU, {(uint8 *) & display_menu, (uint8 *) & displaycolor_menu, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAY_IO0, {(uint8 *) & display_stdio0, (uint8 *) & displaycolor_stdio0, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAY_IO1, {(uint8 *) & display_stdio1, (uint8 *) & displaycolor_stdio1, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAY_GRAPH, {(uint8 *) & display_graph, 0, GRAPHICMODE_16COLOR, 1, (320/8), (240/12), 0, 0} },
    { DISPLAY_RSVD, {(uint8 *) & display_rsvd, (uint8 *) & displaycolor_rsvd, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} }
};
# 149 "0_Src/0_AppSw/Tricore/TftApp/tft_app.c"
void tft_app_init (uint8 RtcRunning)
{

    IfxSrc_init(&(*(Ifx_SRC *)0xF0038000u).GPSR.GPSR[0].SR0, 0, 2);
    IfxSrc_enable(&(*(Ifx_SRC *)0xF0038000u).GPSR.GPSR[0].SR0);
    ...
    conio_driver.pdasmirror = &das_buffer[0];
...
extern void tft_app_run(void){
 display_io_run();
 controlmenu.cpuseconds = controlmenu.cpuseconds + 2*0.1;
