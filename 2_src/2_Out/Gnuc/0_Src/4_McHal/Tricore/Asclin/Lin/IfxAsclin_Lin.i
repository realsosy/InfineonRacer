# 1 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 29 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 1 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.h" 1
# 179 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
...
# 180 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.h" 2
# 197 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
typedef struct
{
    uint8 txHeaderEnd : 1;
...
extern void IfxAsclin_Lin_waitForReceivedHeader(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_waitForReceivedResponse(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_waitForTransmittedHeader(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_waitForTransmittedResponse(IfxAsclin_Lin *asclin);
# 30 "0_Src/4_McHal/Tricore/Asclin/Lin/IfxAsclin_Lin.c" 2
...
void IfxAsclin_Lin_receiveHeader(IfxAsclin_Lin *asclin, uint8 *id)
{
    ...
    IfxAsclin_Lin_waitForReceivedHeader(asclin);
...
void IfxAsclin_Lin_receiveResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length)
{
    ...
    IfxAsclin_enableTxFifoOutlet(asclinSFR, 0);
    IfxAsclin_enableRxFifoInlet(asclinSFR, 1);
    IfxAsclin_Lin_waitForReceivedResponse(asclin);
...
void IfxAsclin_Lin_sendHeader(IfxAsclin_Lin *asclin, uint8 *id)
{
    ...
    IfxAsclin_Lin_waitForTransmittedHeader(asclin);
}
...
void IfxAsclin_Lin_sendResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length)
{
    ...
    IfxAsclin_Lin_waitForTransmittedResponse(asclin);
}
