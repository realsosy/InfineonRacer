...
void drawInfineonLogo(void)
{
    ...
    for(i = 0; i < TFT_YSIZE - FONT_YSIZE; i++)
    {
        ...
        {
            conio_graphics_set(DISPLAY_TAB4, j, i, RED);
        }
    }
    // set red frame
    for(i = 5; i < TFT_YSIZE - FONT_YSIZE - 5; i++)
    {
        ...
        {
            conio_graphics_set(DISPLAY_TAB4, j, i, BLUE);
        }
    }
    ...
    for(i = 10; i < TFT_YSIZE - FONT_YSIZE - 10; i++)
    {
        ...
        {
           conio_graphics_set(DISPLAY_TAB4, j, i, WHITE);
        }
    }
    ...
    for(i = 0; i < height; i++)
    {
        for(j = 0; j < width; j++)
        {
            ...
            if(color != 255)
            {
                conio_graphics_set(DISPLAY_TAB4, x + j, y + height - i, color);
            }
            count--;
        }
    }
