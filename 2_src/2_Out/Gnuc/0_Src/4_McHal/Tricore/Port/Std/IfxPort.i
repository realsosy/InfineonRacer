# 1 "0_Src/4_McHal/Tricore/Port/Std/IfxPort.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Port/Std/IfxPort.c"
# 29 "0_Src/4_McHal/Tricore/Port/Std/IfxPort.c"
...
# 30 "0_Src/4_McHal/Tricore/Port/Std/IfxPort.c" 2
...
boolean IfxPort_disableEmergencyStop(Ifx_P *port, uint8 pinIndex)
{
    ...
    for (portIndex = 0; portIndex < (13); portIndex++)
    {
...
void IfxPort_setPinMode(Ifx_P *port, uint8 pinIndex, IfxPort_Mode mode)
{
    ...
    if ((port == &(*(Ifx_P *)0xF003E000u)) || (port == &(*(Ifx_P *)0xF003E100u)))
    {
        IfxScuWdt_clearCpuEndinit(passwd);
