# 1 "0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.c"
# 29 "0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.c"
...
# 30 "0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.c" 2
...
void IfxVadc_startupCalibration(Ifx_VADC *vadc)
{
    ...
    do
    {
        ...
        for (adcCalGroupNum = 0; adcCalGroupNum < (2); adcCalGroupNum++)
        {
