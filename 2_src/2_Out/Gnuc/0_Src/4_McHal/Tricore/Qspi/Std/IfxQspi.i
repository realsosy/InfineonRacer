# 1 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.c"
# 29 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.c"
...
# 45 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.h" 2
# 1 "./0_Src/1_SrvSw/If/SpiIf.h" 1
# 34 "./0_Src/1_SrvSw/If/SpiIf.h"
...
# 47 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.h" 2
...
# 30 "0_Src/4_McHal/Tricore/Qspi/Std/IfxQspi.c" 2
...
uint32 IfxQspi_calculateBasicConfigurationValue(Ifx_QSPI *qspi, const IfxQspi_ChannelId channelId, const SpiIf_ChMode *chMode, const float baudrate)
{
    ...
    bacon.B.LAST = 0;
    bacon.B.IPRE = pre;
    bacon.B.IDLE = chMode->csInactiveDelay;
    bacon.B.LPRE = pre;
    bacon.B.LEAD = chMode->csLeadDelay;
    bacon.B.TPRE = pre;
    bacon.B.TRAIL = chMode->csTrailDelay;
...
uint32 IfxQspi_calculateTimeQuantumLength(Ifx_QSPI *qspi, float maxBaudrate)
{
    ...
    uint32 tq = __max((uint32)((((divider) - (sint32)(divider)) > 0.5) ? (1 + (sint32)(divider)) : ((sint32)(divider))) - 1, 0);
    return tq;
}
