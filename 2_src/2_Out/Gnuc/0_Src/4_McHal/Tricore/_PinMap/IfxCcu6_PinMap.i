# 1 "0_Src/4_McHal/Tricore/_PinMap/IfxCcu6_PinMap.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/_PinMap/IfxCcu6_PinMap.c"
# 26 "0_Src/4_McHal/Tricore/_PinMap/IfxCcu6_PinMap.c"
...
# 27 "0_Src/4_McHal/Tricore/_PinMap/IfxCcu6_PinMap.c" 2
...
IfxCcu6_Cc60_Out IfxCcu61_CC60_P11_12_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u),12}, IfxPort_OutputIdx_alt5};
IfxCcu6_Cc60_Out IfxCcu61_CC60_P20_8_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003C000u), 8}, IfxPort_OutputIdx_alt7};
IfxCcu6_Cc60_Out IfxCcu61_CC60_P33_3_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 3}, IfxPort_OutputIdx_alt7};
IfxCcu6_Cc60_Out IfxCcu61_CC60_P33_5_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 5}, IfxPort_OutputIdx_alt7};
...
IfxCcu6_Cc61_Out IfxCcu61_CC61_P11_11_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u),11}, IfxPort_OutputIdx_alt5};
...
IfxCcu6_Cc61_Out IfxCcu61_CC61_P33_6_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 6}, IfxPort_OutputIdx_alt7};
...
IfxCcu6_Cc62_Out IfxCcu61_CC62_P11_10_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u),10}, IfxPort_OutputIdx_alt5};
...
IfxCcu6_Ccpos0_In IfxCcu60_CCPOS0C_P13_1_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003B300u), 1}, Ifx_RxSel_c};
IfxCcu6_Ccpos0_In IfxCcu60_CCPOS0D_P40_11_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003E000u),11}, Ifx_RxSel_d};
...
IfxCcu6_Ccpos1_In IfxCcu60_CCPOS1B_P41_0_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003E100u), 0}, Ifx_RxSel_b};
IfxCcu6_Ccpos1_In IfxCcu60_CCPOS1C_P13_2_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003B300u), 2}, Ifx_RxSel_c};
IfxCcu6_Ccpos1_In IfxCcu61_CCPOS1A_P00_8_IN = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003A000u), 8}, Ifx_RxSel_a};
IfxCcu6_Ccpos1_In IfxCcu61_CCPOS1B_P41_2_IN = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003E100u), 2}, Ifx_RxSel_b};
IfxCcu6_Ccpos1_In IfxCcu61_CCPOS1C_P33_6_IN = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 6}, Ifx_RxSel_c};
IfxCcu6_Ccpos1_In IfxCcu61_CCPOS1D_P41_3_IN = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003E100u), 3}, Ifx_RxSel_d};
IfxCcu6_Ccpos2_In IfxCcu60_CCPOS2A_P02_8_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003A200u), 8}, Ifx_RxSel_a};
IfxCcu6_Ccpos2_In IfxCcu60_CCPOS2C_P13_3_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003B300u), 3}, Ifx_RxSel_c};
...
IfxCcu6_Cout60_Out IfxCcu61_COUT60_P11_9_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u), 9}, IfxPort_OutputIdx_alt5};
...
IfxCcu6_Cout60_Out IfxCcu61_COUT60_P33_7_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 7}, IfxPort_OutputIdx_alt7};
...
IfxCcu6_Cout61_Out IfxCcu61_COUT61_P11_6_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u), 6}, IfxPort_OutputIdx_alt5};
...
IfxCcu6_Cout62_Out IfxCcu61_COUT62_P11_3_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u), 3}, IfxPort_OutputIdx_alt5};
...
IfxCcu6_Cout63_Out IfxCcu61_COUT63_P11_2_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003B100u), 2}, IfxPort_OutputIdx_alt5};
IfxCcu6_Cout63_Out IfxCcu61_COUT63_P20_7_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003C000u), 7}, IfxPort_OutputIdx_alt7};
IfxCcu6_Cout63_Out IfxCcu61_COUT63_P33_2_OUT = {&(*(Ifx_CCU6 *)0xF0002B00u), {&(*(Ifx_P *)0xF003D300u), 2}, IfxPort_OutputIdx_alt7};
IfxCcu6_Ctrap_In IfxCcu60_CTRAPA_P13_0_IN = {&(*(Ifx_CCU6 *)0xF0002A00u), {&(*(Ifx_P *)0xF003B300u), 0}, Ifx_RxSel_a};
...
const IfxCcu6_Cc60_Out *IfxCcu6_Cc60_Out_pinTable[2][6] = {
    {
...
const IfxCcu6_Cc61_Out *IfxCcu6_Cc61_Out_pinTable[2][6] = {
    {
...
const IfxCcu6_Ccpos2_In *IfxCcu6_Ccpos2_In_pinTable[2][3] = {
    {
...
const IfxCcu6_Cout60_Out *IfxCcu6_Cout60_Out_pinTable[2][5] = {
    {
...
const IfxCcu6_Cout63_Out *IfxCcu6_Cout63_Out_pinTable[2][4] = {
    {
