 ...
 *     pwmBcConfig.interrupt.interruptSource = IfxCcu6_InterruptSource_cc61FallingEdge;
 *     pwmBcConfig.interrupt.serviceRequest  = IfxCcu6_ServiceRequest_2;
 *     pwmBcConfig.interrupt.priority        = IFX_INTRPRIO_CCU6;
 *     pwmBcConfig.interrupt.typeOfService   = IfxSrc_Tos_cpu0;
 *
...
typedef struct
{
    const IfxCcu6_Cc60_Out   *cc60Out;            /**< \brief CC60 compare output CC0 */
    const IfxCcu6_Cc61_Out   *cc61Out;            /**< \brief CC61 compare output CC1 */
    const IfxCcu6_Cc62_Out   *cc62Out;            /**< \brief CC62 compare output CC2 */
    const IfxCcu6_Cout60_Out *cout60;             /**< \brief CC60 compare output COUT0 */
    const IfxCcu6_Cout61_Out *cout61;             /**< \brief CC61 compare output COUT1 */
    const IfxCcu6_Cout62_Out *cout62;             /**< \brief CC62 compare output COUT2 */
    const IfxCcu6_Cout63_Out *cout63;             /**< \brief CC63 compare output COUT3 */
