...
typedef struct
{
    const IfxQspi_Sclk_In  *sclk;          /**< \brief Pointer to SLCK in pin */
    IfxPort_InputMode       sclkMode;      /**< \brief The SCLK pin input mode */
    const IfxQspi_Mtsr_In  *mtsr;          /**< \brief Pointer to MTSR in pin */
    IfxPort_InputMode       mtsrMode;      /**< \brief The MTSR pin input mode */
    const IfxQspi_Mrst_Out *mrst;          /**< \brief Pointer to MRST out pin */
    IfxPort_OutputMode      mrstMode;      /**< \brief The MRST pin output mode */
    const IfxQspi_Slsi_In  *slsi;          /**< \brief Pointer to SLSI in pin */
...
typedef struct
{
    ...
    const IfxQspi_SpiSlave_Pins *pins;                           /**< \brief structure for QSPI Slave pins */
