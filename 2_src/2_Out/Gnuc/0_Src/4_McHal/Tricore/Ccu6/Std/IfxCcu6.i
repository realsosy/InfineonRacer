# 1 "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c"
# 30 "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c"
...
# 31 "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c" 2
...
void IfxCcu6_setT12InputSignal(Ifx_CCU6 *ccu6, IfxCcu6_T12hr_In *extInput)
{
    ...
    (((extInput->module == ccu6) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"extInput->module == ccu6", "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c", 396, __func__));
}
...
void IfxCcu6_setT13InputSignal(Ifx_CCU6 *ccu6, IfxCcu6_T13hr_In *extInput)
{
    ...
    (((extInput->module == ccu6) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"extInput->module == ccu6", "0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.c", 484, __func__));
}
