# 1 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
# 26 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
# 1 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.h" 1
# 33 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.h"
...
# 34 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.h" 2
...
# 27 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
...
# 28 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
...
# 29 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
...
# 31 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
...
# 32 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
...
# 33 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c" 2
# 57 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
...
static boolean Ifx_Shell_writeResult (Ifx_Shell * shell, Ifx_SizeT Code)
{
    ...
    (((result != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"result != FALSE", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 78, __func__));
...
void Ifx_Shell_process (Ifx_Shell * shell)
{
    ...
    {
# 300 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
        count = 0;
        readCount = (128) - count;
        ...
        for (i = 0; i < count; i++)
        {
            ...
            (((Cmd->length >= Cmd->cursor) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->length >= Cmd->cursor", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 480, __func__));
...
const Ifx_Shell_Command *Ifx_Shell_commandFind (const Ifx_Shell_Command * commandList, pchar commandLine, pchar * args)
{
    ...
    while (command->commandLine != ((void *)0))
    {
        ...
        if ((commandFound != 0) && (Ifx_Shell_parseToken (&commandTemp, buffer, (sizeof(buffer) / sizeof(buffer[0]))) == 0))
        {
...
void Ifx_Shell_execute (Ifx_Shell * shell, pchar commandLine)
{
    ...
    if (shellCommand != ((void *)0))
    {
        if (shellCommand->call (args, shellCommand->data, shell->io) != 0)
        {
...
# 930 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
void Ifx_Shell_cmdEscapeProcess (Ifx_Shell * shell, char EscapeChar1, char EscapeChar2)
{
    ...
    (((result != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"result != FALSE", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 939, __func__));
    ...
    (((cmdStr != ((void *)0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"cmdStr != NULL_PTR", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 951, __func__));
    (((Cmd->cursor < (128)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->cursor < IFX_SHELL_CMD_LINE_SIZE", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 952, __func__));
    (((Cmd->length < (128)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->length < IFX_SHELL_CMD_LINE_SIZE", "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c", 953, __func__));
