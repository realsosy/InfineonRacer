# 1 "0_Src/0_AppSw/Tricore/Main/BasicPort.c"
# 1 "D:\\GitRepo\\InfineonRacer\\2_src\\InfineonRacer_TC23xA//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Main/BasicPort.c"
# 28 "0_Src/0_AppSw/Tricore/Main/BasicPort.c"
...
# 29 "0_Src/0_AppSw/Tricore/Main/BasicPort.c" 2
...
# 30 "0_Src/0_AppSw/Tricore/Main/BasicPort.c" 2
...
# 35 "./0_Src/1_SrvSw/SysSe/Bsp/Bsp.h"
...
# 32 "0_Src/0_AppSw/Tricore/Main/BasicPort.c" 2
...
# 33 "0_Src/0_AppSw/Tricore/Main/BasicPort.c" 2
# 50 "0_Src/0_AppSw/Tricore/Main/BasicPort.c"
Basic_Port IR_Port;
IR_MotorEn_t IR_MotorEn = {0, 0};
...
# 66 "0_Src/0_AppSw/Tricore/Main/BasicPort.c"
static void setOutputPin(Ifx_P *port, uint8 pin, boolean state)
{
    if (state)
    {
...
void BasicPort_init(void)
{
    ...
    IfxPort_setPinMode(IfxPort_P13_1.port, IfxPort_P13_1.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P13_1.port, IfxPort_P13_1.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P13_1.port, IfxPort_P13_1.pinIndex, IR_Port.led108);

 IfxPort_setPinMode(IfxPort_P13_2.port, IfxPort_P13_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P13_2.port, IfxPort_P13_2.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P13_2.port, IfxPort_P13_2.pinIndex, IR_Port.led109);

 IfxPort_setPinMode(IfxPort_P13_3.port, IfxPort_P13_3.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P13_3.port, IfxPort_P13_3.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P13_3.port, IfxPort_P13_3.pinIndex, IR_Port.led110);


    IfxPort_setPinMode(IfxPort_P02_0.port, IfxPort_P02_0.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P02_0.port, IfxPort_P02_0.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P02_0.port, IfxPort_P02_0.pinIndex, IR_Port.m11_inh);

    IfxPort_setPinMode(IfxPort_P00_2.port, IfxPort_P00_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P00_2.port, IfxPort_P00_2.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P00_2.port, IfxPort_P00_2.pinIndex, IR_Port.m12_inh);

    IfxPort_setPinMode(IfxPort_P02_2.port, IfxPort_P02_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P02_2.port, IfxPort_P02_2.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P02_2.port, IfxPort_P02_2.pinIndex, IR_Port.m21_inh);

    IfxPort_setPinMode(IfxPort_P33_5.port, IfxPort_P33_5.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P33_5.port, IfxPort_P33_5.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P33_5.port, IfxPort_P33_5.pinIndex, IR_Port.m22_inh);


 IfxPort_setPinModeInput(IfxPort_P00_0.port, IfxPort_P00_0.pinIndex, IfxPort_InputMode_noPullDevice);
 IfxPort_setPinModeInput(IfxPort_P00_1.port, IfxPort_P00_1.pinIndex, IfxPort_InputMode_noPullDevice);

 IR_Port.port00_0 = IfxPort_getPinState(IfxPort_P00_0.port, IfxPort_P00_0.pinIndex);
 IR_Port.port00_1 = IfxPort_getPinState(IfxPort_P00_1.port, IfxPort_P00_1.pinIndex);
...
void BasicPort_run(void)
{
 ...
 setOutputPin(IfxPort_P02_0.port, IfxPort_P02_0.pinIndex, IR_MotorEn.Motor0Enable);
 setOutputPin(IfxPort_P00_2.port, IfxPort_P00_2.pinIndex, IR_MotorEn.Motor0Enable);
 setOutputPin(IfxPort_P02_2.port, IfxPort_P02_2.pinIndex, IR_MotorEn.Motor1Enable);
 setOutputPin(IfxPort_P33_5.port, IfxPort_P33_5.pinIndex, IR_MotorEn.Motor1Enable);
