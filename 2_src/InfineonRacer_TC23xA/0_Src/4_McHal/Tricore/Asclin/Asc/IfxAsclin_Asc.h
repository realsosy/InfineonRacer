...
typedef struct
{
    const IfxAsclin_Cts_In  *cts;           /**< \brief ASC clear to send (CTS) pin */
    IfxPort_InputMode        ctsMode;       /**< \brief Cts pin as input */
    const IfxAsclin_Rx_In   *rx;            /**< \brief ASC Rx pin */
    IfxPort_InputMode        rxMode;        /**< \brief Rx pin as input */
    const IfxAsclin_Rts_Out *rts;           /**< \brief ASC (request to send) RTS pin */
    IfxPort_OutputMode       rtsMode;       /**< \brief Rts as output */
    const IfxAsclin_Tx_Out  *tx;            /**< \brief ASC Tx pin */
...
typedef struct
{
    ...
    const IfxAsclin_Asc_Pins      *pins;               /**< \brief structure for ASC pins */
